...
const SignupScreen = props => {
  ...
  const checkValidation = () => {
    ...
    if (firstName.IsValid && firstName.value != '' &&
    lastName.IsValid && lastName.value != '' &&
    mobile.IsValid && mobile.value != '' &&
    passowrd.IsValid && passowrd.value != '' &&
    ...
    <View style={Style.container}>
      ...
      <ScrollView style={Style.socialContainer} >
        ...
        <View style={Style.form}>
          ...
          <TouchableOpacity style={{ width: '100%', marginTop: 50, opacity: checkValidation() ? 1 : 0.5 }} disabled={!checkValidation()} onPress={onSubmit}>
